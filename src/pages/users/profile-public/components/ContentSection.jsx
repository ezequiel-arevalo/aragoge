  ...
  <div className="p-6 bg-white rounded-lg shadow-md mt-4">
    {activeTab === 'info' && (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
        <h2 className="text-h2 font-title font-semibold mb-2 text-gray-800">Información del usuario</h2>
    ...
    {isProfessional && activeTab === 'schedules' && (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
        <h2 className="text-h2 font-title font-semibold mb-2 text-gray-800">Planificaciones</h2>
        <p className="text-gray-500">Aquí se mostrarían las planificaciones del profesional.</p>
      </motion.div>
    )}
    {isProfessional && activeTab === 'services' && (
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
        <h2 className="text-h2 font-title font-semibold mb-2 text-gray-800">Servicios</h2>
