            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="bg-white shadow-md rounded-lg overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-600 mt-1">Gestiona tus suscripciones activas e históricas</p>
                    </div>
                    <div className="p-6">
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Planificación</th>
                                        ...
                                        subscriptions.map((sub) => (
                                            <tr key={sub.id}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    <Link to={`/planning/${sub.planning_id}`} className="hover px-1 text-[#DA1641] underline">
                                                        {sub.planning_id}
                                                    </Link>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    {sub.payments && sub.payments.length > 0 && (
                                                        <div className="flex items-center">
                                                            ...
                                                            {sub.payments[0].amount} - {sub.payments[0].payment_method}
                                                        </div>
                                                    )}
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div className="flex space-x-2">
                                                        <Link to={`/subscriptions/${sub.id}`} className="text-[#DA1641] underline">
                                                            Ver Detalles
                                                        </Link>
                                                    </div>
                                                </td>
