      ...
      <div className="flex flex-wrap justify-center md:justify-start space-x-0 md:space-x-4 space-y-2 md:space-y-0 border-b border-bg-primary">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center justify-center md:justify-start gap-2 px-4 py-2 font-font-title text-h6 transition-colors w-full md:w-auto ${activeTab === tab.id
              ? 'text-white'
